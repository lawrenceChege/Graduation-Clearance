...
from SUser.models import SUser, SUserPassword
...
class SUserPasswordChangeForm(forms.ModelForm):
	...
	def __init__(self, *args, **kwargs):
		super(SUserPasswordChangeForm, self).__init__(*args, **kwargs)
